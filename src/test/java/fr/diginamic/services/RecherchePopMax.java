...
public class RecherchePopMax extends Menu {

    public RecherchePopMax(int choixMenu, String typeRecherche) {
    ...
    public void traiter(Scanner scanner, Recensement recens) {
        ...
        if (choixMenu == 4 || choixMenu == 5 || choixMenu == 8 )  {
            ...
            List<Country> choixNumber2= new ArrayList<>();
            if (choixMenu == 6) {
            ...
            for (Country country : choixNumber2) {
                // On ne rentre qu'une fois dans le corps de ma condition
                if(choixRecherche.equals(country.getCode())) {
                    choixListe = country.getListeVille();
                    System.out.println("Top10 des villes pour le/la " + typeRecherche + " " + country.getNom() );
                }
            }
        }
